    ...
    <div className="pt-24 pb-20 px-6 max-w-4xl mx-auto text-white min-h-[calc(100vh-200px)]">
      ...
      <div className="mt-20 border-t border-white/5 pt-12 flex justify-center">
        <a 
          ...
          className="glass-panel p-8 rounded-3xl flex flex-col items-center text-center w-full max-w-md transition-transform hover:-translate-y-2 hover:border-[#25D366]/50 group cursor-pointer"
        >
