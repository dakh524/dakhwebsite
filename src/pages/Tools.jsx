      ...
      <main className="pt-32 pb-20 px-8 max-w-7xl mx-auto">
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {tools.map((tool) => (
              <div key={tool.id} className="glass-card rounded-xl p-8 transition-all duration-500 flex flex-col group hover:border-primary/30">
                ...
                <div className="flex gap-4">
                  <button 
                    ...
                    className="w-full py-4 px-4 rounded-xl bg-primary text-[#004050] font-black text-xs uppercase tracking-[0.15em] flex items-center justify-center gap-2 hover:bg-primary-dim transition-all hover:scale-[1.02] active:scale-95 shadow-[0_5px_15px_rgba(0,209,255,0.2)]"
                  >
            ...
            <div className="glass-card rounded-xl p-8 border-dashed border-white/20 flex flex-col justify-center items-center text-center group min-h-[400px]">
          ...
          <section className="mt-20 lg:col-span-2 glass-card rounded-xl p-10 flex flex-col md:flex-row gap-10 items-center overflow-hidden group">
            <div className="flex-1 z-10">
              ...
              <p className="text-on-surface-variant leading-relaxed mb-8">
                Our internal incubator where students collaborate with industry veterans to build the next generation of DAKH tools. This is where academic theory becomes digital reality.
              </p>
