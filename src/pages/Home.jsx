...
<h1 className="text-4xl md:text-9xl font-black mb-8 leading-[0.9] tracking-tightest glow">
                Join &<br /> 
                <span ref={wordRef} className="text-gradient inline-block min-w-0 md:min-w-[700px]">
...
<div className="max-w-7xl mx-auto px-6 md:px-8">
<div className="glass-panel bg-surface-container-highest/30 rounded-[32px] md:rounded-[48px] p-6 sm:p-12 md:p-20 overflow-hidden relative">
...
<div className="flex flex-col sm:flex-row gap-4 sm:gap-6">
  <button onClick={handleApply} className="bg-white text-black px-8 md:px-12 py-4 md:py-6 rounded-2xl font-black text-[10px] md:text-xs uppercase tracking-[0.2em] transition-all hover:scale-105 active:scale-95 shadow-2xl btn-vibrate">
    Get Started
  </button>
  <button onClick={handleWhatsApp} className="bg-[#25D366] text-white px-8 md:px-12 py-4 md:py-6 rounded-2xl font-black text-[10px] md:text-xs uppercase tracking-[0.2em] transition-all hover:scale-105 active:scale-95 shadow-2xl flex items-center justify-center gap-3 btn-vibrate">
    <span className="material-symbols-outlined text-lg">chat</span>
    Join WhatsApp
  </button>
</div>
